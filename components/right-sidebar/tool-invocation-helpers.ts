...
export const TOOL_META: Record<OrionToolName, ToolMeta> = {
  ...
  list_notebooks: { labelPending: "Listing notebooks", labelDone: "Listed notebooks", icon: Library },
  ...
  unuse_notebook: { labelPending: "Disconnecting notebook", labelDone: "Disconnected notebook", icon: BookOpen },
