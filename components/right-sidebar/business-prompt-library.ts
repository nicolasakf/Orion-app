...
export const BUSINESS_PROMPT_CATEGORIES: readonly BusinessPromptCategory[] = [
  {
    ...
    prompts: [
      ...
      {
        id: "compare-files",
        title: "Compare files or versions",
        prompt:
      ...
      },
      {
        ...
        title: "Assess project readiness",
        prompt:
  ...
  },
  {
    ...
    prompts: [
      ...
      },
      {
        ...
        title: "Check the data before using it",
        prompt:
  ...
  },
  {
    ...
    prompts: [
      ...
      },
      {
        ...
        title: "Prepare a recurring update",
        prompt:
      ...
      },
      {
        ...
        title: "Prepare a decision brief",
        prompt:
  ...
  },
  {
    ...
    prompts: [
      ...
      },
      {
        ...
        title: "Create a scheduled update",
        prompt:
      ...
      },
      {
        ...
        title: "Streamline a multi-step process",
        prompt:
